...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 w-full h-10 flex items-center bg-[#1e0823] text-pink-100 border-b-2 border-[#6f2020]'>
      <div className='w-full mx-auto sm:w-[675px] md:w-[810px] lg:w-[1024px] flex justify-between items-center px-1 xsm:px-4'>
        ...
        <div className='flex gap-1 xsm:gap-2 sm:gap-10'>
          <Link 
            to='/display' 
            className={`${currentPath === '/display' ? 'text-white' : 'text-pink-200'} relative`}
          >
            Display details
          ...
          <Link 
            to='/' 
            className={`${(currentPath === '/' || currentPath === '/form') ? 'text-white' : 'text-pink-200'} relative`}
          >
            Fill Form
