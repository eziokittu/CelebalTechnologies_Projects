  ...
  return (
    <div className="fixed top-0 w-screen h-screen z-20 bg-black/85 text-white flex justify-center ">
      <div className="flex flex-col mt-12">
        <div className={`${type==='error' ? 'bg-red-500' : 'bg-blue-500'} text-center flex gap-4 items-center justify-center p-4 rounded-t-lg`}
        >
          ...
          <p className='text-2xl font-bold'>{overlayHeading}</p>
        </div>
